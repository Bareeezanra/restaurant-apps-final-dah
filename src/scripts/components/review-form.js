class ReviewForm extends HTMLElement {
  ...
  async _initializeForm() {
    ...
    form.addEventListener('submit', async (e) => {
      ...
      if (!nameInput.value.trim() || !reviewInput.value.trim()) {
        console.log('Form kosong, validasi berjalan'); // Log untuk debugging
        this._showMessage('Form tidak boleh kosong', 'error');
  ...
  _showMessage(message, type) {
    console.log('Pesan kesalahan:', message, 'Tipe:', type); // Debugging
